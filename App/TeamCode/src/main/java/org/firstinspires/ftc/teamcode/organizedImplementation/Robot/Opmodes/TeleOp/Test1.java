 ...
 */
@TeleOp (name = "Main TeleOp Special Button", group = "TeleOp")
//@Disabled
public class Test1 extends LinearOpMode {
    ...
    private double leftMotorMul = 0.75;
    private double rightMotorMul = 0.75;
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            if (gamepad1.x) leftMotorMul = Range.clip(leftMotorMul + 0.0001, 0, 1);
            else if (gamepad1.y) leftMotorMul = Range.clip(leftMotorMul - 0.0001, 0, 1);

            if (gamepad1.a) rightMotorMul = Range.clip(rightMotorMul + 0.0001, 0, 1);
            else if (gamepad1.b) rightMotorMul = Range.clip(rightMotorMul - 0.0001, 0, 1);
            ...
            if (accelMode) {
                ...
                leftMotor.setPower(gamepad1.left_stick_y * leftMotorMul);
                rightMotor.setPower(gamepad1.right_stick_y * rightMotorMul);
            }
    ...
    private void addMessages() {
        ...
        telemetry.addData("Multipliers", "Left: " + leftMotorMul + ", Right: " + rightMotorMul);
    }
